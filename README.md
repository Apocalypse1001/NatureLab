# NatureLab 0.12.0 - Educational FloodLab / RiverLab
...
> **Продолжение работы:** [`docs/07_river_plan.md`](docs/07_river_plan.md) — блок
> «С ЧЕГО ПРОДОЛЖИТЬ» описывает v0.13.0 «Паводок» и то, чем закрылась v0.12.0.
...
python tools\make_release.py 0.12.0
```

Создаёт `releases\NatureLab_v0.12.0.zip` и записывает его SHA-256 в
