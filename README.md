...
| | |
|---|---|
| **River** | The town on the bank of a running river, fed by a prescribed discharge of 12 m³/s, at which the channel runs about a metre deep and the town stays dry. At the discharge slider's maximum of 80 m³/s the channel goes bankfull at 2.1 m, the street is wet from about 90 s, and about 8 cm of water stands there at three minutes. |
...
| [`docs/12_tsunami_plan.md`](docs/12_tsunami_plan.md) | The tsunami's first version — superseded, and kept as the record of a wrong question |
| [`docs/13_tsunami2_plan.md`](docs/13_tsunami2_plan.md) | Why that scene showed no tsunami, and the kilometre-scale coast that replaced it |
