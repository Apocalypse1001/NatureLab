# NatureLab 0.11.0 - Educational FloodLab / RiverLab
...
> **Продолжение работы:** [`docs/07_river_plan.md`](docs/07_river_plan.md) — следующая
> версия v0.12.0 «Река», первая задача внутри неё названа там же.
...
python tools\make_release.py 0.11.0
```

Создаёт `releases\NatureLab_v0.11.0.zip` и записывает его SHA-256 в
