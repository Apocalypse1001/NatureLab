# NatureLab 0.14.1 — Educational FloodLab / RiverLab / VolcanoLab / TsunamiLab
...
**Оставшееся ограничение, названное прямо:** отступление (62 м) меньше затопления
(258 м), потому что вода стекает с мелкого шельфа медленно и донное трение душит именно
медленный отток. У настоящего цунами они сопоставимы. Увеличение периода отступление уже
не меняет — это потолок модели, а не настройки.
...
Создаёт `releases\NatureLab_v0.14.1.zip` и записывает его SHA-256 в
