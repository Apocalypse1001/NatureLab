# NatureLab 0.14.0 — Educational FloodLab / RiverLab / VolcanoLab / TsunamiLab
...
> также: «лава встречает воду» (вынесено из v0.14.0) и река с паводком, отложенная на
> v0.15.0 — её план и незакрытый дефект солвера в
...
Создаёт `releases\NatureLab_v0.14.0.zip` и записывает его SHA-256 в
